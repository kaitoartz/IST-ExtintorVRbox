...
public class FadeEffect : MonoBehaviour
{
    ...
    [SerializeField] private UnityEvent onFadeEnd = new UnityEvent();
    ...
    private class TextFadeable : IFadeable
    {
        private TextMeshProUGUI texto;

        public TextFadeable(TextMeshProUGUI texto)
        {
            this.texto = texto;
        }

        public float GetAlpha() => texto.color.a;
    ...
    private class ImageFadeable : IFadeable
    {
        private Image imagen;

        public ImageFadeable(Image imagen)
        {
            this.imagen = imagen;
        }

        public float GetAlpha() => imagen.color.a;
    ...
    private void Awake()
    {
        ...
        {
            if (texto != null)
                fadeables.Add(new TextFadeable(texto));
        }

        foreach (var imagen in imagenes)
        {
            if (imagen != null)
                fadeables.Add(new ImageFadeable(imagen));
        }
    }
